...
class AudioHandler {
  Future<AudioSuccess> getAudio(AudioRequestParams params) async {
    ...
    final audioClient = AudioClient(
        client: http.Client(), authHeader: BearerAuthenticationHeader(token: Config.authToken!.token), audioTypeHeader: AudioTypeHeader(audioFormat: params.audioFormat));
